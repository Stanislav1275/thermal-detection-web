...
export const apiClient = {
  upload: (files: File[], confidence: number = 0.5, name?: string | null) => {
  ...
  downloadJobResults: (jobId: string, options: { original?: boolean; minConfidence?: number; onlyWithDetections?: boolean }) => {
